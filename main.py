...
message3 = tk.Label(window, text="IntelliCloud" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
...
head1 = tk.Label(frame1, text="                       For Registered Canditates                       ", fg="black",bg="#3ece48" ,font=('times', 17, ' bold ') )
head1.place(x=0,y=0)
...
message1 = tk.Label(frame2, text="Click Below to Save Registration" ,bg="#00aeff" ,fg="black"  ,width=39 ,height=1, activebackground = "yellow" ,font=('times', 15, ' bold '))
...
if exists:
    ...
    res = 0
message.configure(text='Total students : '+str(res))
...
clearButton = tk.Button(frame2, text="Delete", command=clear  ,fg="black"  ,bg="#ea2a2a"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Delete", command=clear2  ,fg="black"  ,bg="#ea2a2a"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
clearButton2.place(x=335, y=172)    
takeImg = tk.Button(frame2, text="Click Here", command=TakeImages  ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save", command=psw ,fg="white"  ,bg="blue"  ,width=34  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
trainImg.place(x=30, y=380)
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="green"  ,width=35  ,height=1, activebackground = "white" ,font=('times', 15, ' bold '))
